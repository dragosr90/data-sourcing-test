    ...
    def check_deadline_violations(
        ...
        if missing_files:
            ...
            self._append_to_process_log(
                **log_config,
                source_system=source_system.upper(),  # Convert back to uppercase for logging # noqa: E501
                comments=f"Deadline passed ({deadline}): Missing expected file {file_path.upper()}",  # noqa: E501
                status="Failed",
            )
