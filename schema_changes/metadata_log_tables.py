...
from abnamro_bsrc_etl.month_setup.dial_derive_snapshotdate import derive_snapshot_date
...
# Table schemas
def get_metadata_table_schemas(table: str = "") -> dict:
    metadata_tables = {
        "metadata_dial_schedule": StructType(
            [
                ...
                StructField("FileDeliveryStep", IntegerType(), nullable=False),
        ...
        "metadata_ssf_abc_list": StructType(
            [
                ...
                StructField("ABCKey", StringType(), nullable=False),
                StructField("SSFTableName", StringType(), nullable=True),
                StructField("XSDVersion", StringType(), nullable=False),
            ]
        ),
        "metadata_nonssf": StructType(
            [
                StructField("SourceSystem", StringType(), nullable=False),
                StructField("SourceFileName", StringType(), nullable=False),
                StructField("SourceFileFormat", StringType(), nullable=False),
                StructField("SourceFileDelimiter", StringType(), nullable=False),
                StructField("StgTableName", StringType(), nullable=False),
                StructField("FileDeliveryStep", IntegerType(), nullable=False),
                StructField("FileDeliveryStatus", StringType(), nullable=False),
            ]
...
def get_log_table_schemas(table: str = "") -> dict:
    log_tables = {
...
def create_metadata_log_tables(spark: SparkSession, month_no: str) -> None:
    ...
    log_entry = [
        {
            ...
            "FileDeliveryStep": row["FileDeliveryStep"],
