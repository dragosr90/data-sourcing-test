...
# ======== TEMPORARY ADDITION BECAUSE OF NEW CHANGES IN PACKAGE ========
from pathlib import Path
import abnamro_bsrc_etl.config.constants
working_dir = f"/Workspace/Users/nina.schoeber@nl.abnamro.com/bsrc-etl"
...
def run_mapping(
    ...
    delivery_entity: str = "",
    parent_workflow: str = "",
    business_logic_path: Path | str = PROJECT_ROOT_DIRECTORY / "business_logic",
    run_id: int = 1,
    *,
    local: bool = False,
) -> None:
    ...
    business_logic_dict = parse_yaml(
        ...
        # business_logic_path=business_logic_path, TEMP FIX
    )
