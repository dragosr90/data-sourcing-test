...
def source_data():
    return {
        ...
        "table_b": {
            ...
            "schema": ["col01", "col09", "col10", "col09b"],
        },
        "table_c_testd1": {
            "data": [
                (1, 10, 11),
...
def test_pipeline_no_transformation(spark_session, source_data, caplog):
    ...
    business_logic = {
        "description": "Test business logic without transformation steps",
...
def test_run_mapping(spark_session):
    ...
    for file in Path.iterdir(MAPPING_ROOT_DIR / "spark-warehouse/test_pivot_table"):
        Path.unlink(file)
    Path.rmdir(MAPPING_ROOT_DIR / "spark-warehouse/test_pivot_table")
